    ...
    return(
        <MainBlock>
            <AboutMe>
                ...
                <BlockDesktop text="MOBILE TESTING & DEVELOPMENT" text2="Frontend development using React Native (JS/TS)." text3="Development of an automation test suites (Appium & JavaScript with Node. js)." imageSrc={MobileDev} altText="Ruler Img" />
                </Flex>
                <Flex>
                <BlockDesktop text="VERSION CONTROL" text2="I can use version control systems well." text3="Tools: github & bitbucket." imageSrc={Git} altText="Version Control System" />
