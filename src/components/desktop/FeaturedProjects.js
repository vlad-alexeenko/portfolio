    ...
    return(
        <MainBlock>
            <AboutMe>
                ...
                <Project text="Cubionic" text2="Frontend development (React & TS), API testing, Functional and Smoke testing. On that project, I created a Postman collection for API automation testing & interaction. Performed frontend development tasks." link="https://cubionic.com/" imageSrc={Cubionic} altText="Cubionic logo"/>
                </Flex>
            </AboutMe>
        </MainBlock>
    )
